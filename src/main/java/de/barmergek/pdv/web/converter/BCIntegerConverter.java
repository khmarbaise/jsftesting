package de.barmergek.pdv.web.converter;
 ...
 * Optionale Attribute:
 * - maxLength gibt die maximal erlaubte Länge des Integers an.
 * - formatString = true bedeutet, dass der String mit Tausendertrennzeichen ausgegeben wird.
...
public class BCIntegerConverter implements Converter
{
    ...
    private Object parseString(String _eingabe, UIComponent _component)
    {
        ...
        {
            char c = sb.charAt(i);
            if ((c == '0' && ersteZahlUngleichNull == false) || c == ' ' || c == '.')
            {
                sb.deleteCharAt(i);
                i--;
            }
    ...
    @Override
    public Object getAsObject(FacesContext _fc, UIComponent _component, String _value)
    {
        ...
        if (obj instanceof String)
        {
            ...
            _fc.addMessage(element.getClientId(_fc),
                           new FacesMessage(FacesMessage.SEVERITY_ERROR, getDefaultFehlertext(_component) + " (" + obj + ")", ""));
            return null;
        }
    ...
    @Override
    public String getAsString(FacesContext _fc, UIComponent _component, Object _obj)
    {
